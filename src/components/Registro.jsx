                ...
                <div className="contenedor-login abs-center">
                    <div className="profile-content">
                        <div className="container pb-3">
                            <div className="row">
                                <div className="profile-name mt-3 text-center border-bottom border-3 border-warning pb-3 texto-naranja">
                                    Registrar Usuario
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container pb-3">
                            <div className="row text-center">
                                <div className="col">
                                    <button className="btn btn-warning  isI" type="button">
                                        Registrar Usuario
                                    </button>
                                </div>
                                <div className="col">
                                    <button className="btn btn-dark  isI" type="button">
                                        Cancelar
                                    </button>
                                </div>
                            </div>
